...
A<-"Test" # On crée un objet "A".GaDou
...
CO2[2,3] # extrait le contenu de la deuxième ligne / troisième colonne

CO2[1,] # extrait le contenu de la première ligne

CO2[,1] # extrait le contenu de la première colonne
CO2[,1][2] # [...] peut être utilisé récursivement
CO2$Variable1 # extrait le contenu de la colonne "Variable1"
